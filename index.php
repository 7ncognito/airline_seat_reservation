...
<title>Book My Trip</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg fixed-top py-3 bg-info" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./"><i><?php echo $_SESSION['setting_name'] ?><img src="img/airtic.png" style="width: 8%;"></i></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="seats.php">Ticket</a></li>
